...
class CodeCompetence1 extends StatefulWidget {
  const CodeCompetence1({Key? key}) : super(key: key);

  @override
  State<CodeCompetence1> createState() => _CodeCompetence1State();
}

class _CodeCompetence1State extends State<CodeCompetence1> {
